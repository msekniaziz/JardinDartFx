...
import tn.jardindart.controllers.Prdtroc.ItemsL;
public class MarketV implements Initializable {
    ...
    void back(ActionEvent event) {
        try {
            // Charger le fichier FXML
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn.jardindart/BackproT.fxml"));
            Parent root = loader.load();
        ...
        for (Produittroc book : BookObservableList) {
            if (book.getNom().toLowerCase().contains(searchText))  {
                try {
                    ...
                    fxmlLoader.setLocation(getClass().getResource("/tn.jardindart/items.fxml"));
    ...
    public MarketV() throws SQLException {
    ...
    void loadBooks() {
        ...
        try {
            for (int i = 0; i < BookObservableList.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn.jardindart/itemsL.fxml"));
                System.out.println("Loading itembook.fxml");
                AnchorPane anchorPane = fxmlLoader.load();
                ItemsL ItemController = fxmlLoader.getController();
...
//        System.out.println(bookicon);
        try {
            for (int i = 0; i < ProdwithObservelist.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn.jardindart/itemstroc.fxml"));
        ...
        if (selectedCategory != null) {
            ...
            try {
                for (int i = 0; i < filteredBooks.size(); i++) {
                    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn.jardindart/items.fxml"));
