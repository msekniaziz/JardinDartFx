...
import tn.jardindart.controllers.prodR.AddProdR;
...
public class ViewPtCollect implements Initializable {
    ...
    public void navigateToAddProdR(PtCollect ptCollect) {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/tn.jardindart/prodR/AddProdR.fxml"));
        try {
