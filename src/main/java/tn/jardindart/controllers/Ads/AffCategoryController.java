...
import tn.jardindart.controllers.Ads.CardCatController;
...
public class AffCategoryController implements Initializable {
    ...
    void loadCartData() {
        ...
        for (Categories cat : categories) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn.jardindart/Ads/cardCat.fxml"));
    ...
    void back(ActionEvent event) {
        try {
            menuc.navigateToFXML("/tn.jardindart/Ads/addCategory.fxml", back   );
        } catch (Exception e) {
            e.printStackTrace();
        }
