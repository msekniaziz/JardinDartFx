...
public class cardMyAdsController implements Initializable {
    ...
    void handleDelete(ActionEvent actionEvent) throws SQLException {
        ...
        frontTop.navigateToFXML("/tn.jardindart/Ads/affMyAds.fxml",deleteButton);
    }
   ...
   void handleEdit(ActionEvent event) {
       if (ads != null) {
           try {
               ...
               // Chargez la vue du formulaire d'édition
               FXMLLoader loader = new FXMLLoader(HelloApplication.class.getResource("/tn.jardindart/Ads/EditAds.fxml"));
               Parent root = loader.load();
