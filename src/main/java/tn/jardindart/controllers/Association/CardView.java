package tn.jardindart.controllers.Association;
...
import tn.jardindart.controllers.DA.AddDA;
import tn.jardindart.controllers.DBM.AddDBM;
...
public class CardView implements Initializable {
    ...
    private void handleDonArgent(Association association) {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/tn.jardindart/DA/AddDA.fxml"));
        try {
    ...
    private void handleDonMateriel(Association association) {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/tn.jardindart/DBM/AddDBM.fxml"));
        try {
            gridPane.getScene().setRoot(fxmlLoader.load());
