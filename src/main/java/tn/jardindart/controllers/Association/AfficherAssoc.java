...
public class AfficherAssoc{
    ...
    private void handleAddAssociation() {
        try {
            menuc.navigateToFXML("/tn.jardindart/Association/AddAssoc.fxml", btn);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void configurerCellulesActions() {
        actionsColumn.setCellFactory(param -> {
            return new TableCell<>() {
                private final JFXButton viewButton = createIconButton(null, "/tn.jardindart/icons/view.png", 20);
...

                {
                    ...
                    editButton.setOnAction(event -> {
                        ...
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn.jardindart/Association/UpdateAssociation.fxml"));
