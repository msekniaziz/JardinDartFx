...
public class MenuBack implements Initializable {
    ...
    public void navigateToListBlogs(ActionEvent actionEvent) {

        navigateToFXML("/tn.jardindart/Blog/Backblog.fxml",btnMenus);
    }
    ...
    public void catAction(ActionEvent actionEvent) {
        navigateToFXML("/tn.jardindart/Ads/affCategory.fxml",btnMenus);
    }

    public void OrderAction(ActionEvent actionEvent) {
        navigateToFXML("/tn.jardindart/Ads/affOrder.fxml",btnOrder);
    }

    public void AdsAction(ActionEvent actionEvent) {
        navigateToFXML("/tn.jardindart/Ads/affAdsBack.fxml",ads);
    }
