...
public class AddBlog {
   ...
   // String uploads = "C:/Users/ROUMAYSA/Downloads/JardinDartFx/JardinDartFx/src/main/resources/images";
  String uploads = "src/main/resources/tn.jardindart/images";
...
//                selectedImageFile = selectedFile;
//                Image image = new Image(selectedFile.toURI().toString());
//                imageid.setImage(image); // Afficher l'image sélectionnée dans ImageView
//
//                // Enregistrer le chemin absolu complet dans la base de données
//                Blogservice blogService = new Blogservice(); // Assurez-vous d'avoir instancié votre service BlogService correctement
//                // Enregistrer le chemin absolu dans la base de données
//                blogService.uploadImage(selectedImageFile.getAbsoluteFile()); // Assurez-vous d'avoir une méthode addImageBlog dans votre service BlogService
//
//            } catch (Exception e) {
//                e.printStackTrace();
