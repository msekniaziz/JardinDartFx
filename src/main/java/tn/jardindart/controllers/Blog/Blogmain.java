...
private like_blogservice like_blogservice;
    ...
    private Pane createCard(Blog blog) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("tn.jardindart/Blog/cardblog.fxml"));
        try {
    ...
    void loadBooks() {
        ...
        try {
            for (int i = 0; i < BookObservableList.size(); i++) {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/tn.jardindart/Blog/cardblog.fxml"));
