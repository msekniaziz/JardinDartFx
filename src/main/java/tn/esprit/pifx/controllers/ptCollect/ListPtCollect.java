...
import tn.esprit.pifx.controllers.prodR.EditProdR;
...
public class ListPtCollect {
    ...
    private void configurerCellulesActions() {
        actionsColumn.setCellFactory(param -> new TableCell<>() {
            private final JFXButton viewButton = createIconButton(null, "/tn/esprit/pifx/icons/carte.png",20);
...
afficherMap();
                ...
                editButton.setOnAction(event -> {
                    ...
                    try {
                        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/tn/esprit/pifx/ptCollect/EditPtCollect.fxml"));
...
//                        Parent root = loader.load();
    ...
    public void afficherMap() {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/tn/esprit/pifx/ptCollect/Map.fxml"));
        try {
