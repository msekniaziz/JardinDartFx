...
public class Cardrep {
    ...
    void modifie_cli(ActionEvent event) {
        ...
        fxmlLoader.setLocation(getClass().getResource("/tn/esprit/applicationgui/EditRep.fxml"));
    ...
    void reloadPage(javafx.event.ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/applicationgui/EditRep.fxml"));
