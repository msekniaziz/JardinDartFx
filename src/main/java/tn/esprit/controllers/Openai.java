...
public class Openai {
    ...
    private static final String API_KEY = "sk-proj-HK3SI6RUSgP8Vu0zyf0wT3BlbkFJ6f3rMfYeJZloJkbQB9ko";
    @FXML
    ...
    void askQuestion(ActionEvent event) {
        ...
        // Call the method from the ChatController class to get the answer
        String answer = index11(question);
    ...
    public String index11(String question) {
        ...
        try {
            ...
            } else if (question.matches("(?i).*Jardindart.*")) {
    ...
    private String getAnswerFromAPI(String question) throws Exception {
